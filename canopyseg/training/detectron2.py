...
khối `train:` với hai trainer kia.
    ...
    python scripts/train.py --config configs/train/maskrcnn_r50_d2.yaml --set data.root=data/export/f4
    python scripts/train.py --config configs/train/mask2former_r50_d2.yaml --probe
