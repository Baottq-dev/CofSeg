# Nhật ký thí nghiệm — YOLOv11-Seg

Người ghi: QuangBao. Mỗi lần chạy thật một dòng, ghi ngay sau khi chạy xong —
...
`benchmark/yolo11/evaluate.py`, không lấy số detectron2/mmdet in ra lúc train (khác
cách tính Boundary).
