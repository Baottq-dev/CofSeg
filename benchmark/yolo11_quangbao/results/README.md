...
`<model>_<fold>`:
    ...
    cp runs/eval/<...>_yolo11s_f4_test/metrics.json     results/yolo11s_f4_metrics.json
    cp runs/eval/<...>_yolo11s_f4_test/per_region.csv   results/yolo11s_f4_per_region.csv
    cp runs/train/<...>/results.csv                    results/yolo11s_f4_train.csv
