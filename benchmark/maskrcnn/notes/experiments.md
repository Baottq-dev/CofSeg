# Nhật ký thí nghiệm — Mask R-CNN R50-FPN

Người ghi: VanNguyen. Mỗi lần chạy thật một dòng, ghi ngay sau khi chạy xong —
...
`benchmark/maskrcnn/evaluate.py`, không lấy số detectron2/mmdet in ra lúc train (khác
cách tính Boundary).
