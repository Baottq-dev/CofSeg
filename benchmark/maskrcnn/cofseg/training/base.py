...
benchmark/maskrcnn/train.py chỉ làm việc với lớp này. Thêm Mask R-CNN, detectron2, hay
...
class Trainer(ABC):
    ...
    def param_defaults(cls) -> dict | None:
        ...
        benchmark/maskrcnn/train.py dùng nó để bắt lỗi gõ sai tên và để in --list-params.
