...
#
#     python benchmark/solov2_phuongquynh/scripts/train.py --config benchmark/solov2_phuongquynh/configs/train/solov2_r50_mm.yaml
"""Huấn luyện một model bất kỳ. Model do config chỉ định, không phải script.
    ...
    python benchmark/solov2_phuongquynh/scripts/train.py --config benchmark/solov2_phuongquynh/configs/train/solov2_r50_mm.yaml --print-config

Truyền siêu tham số thẳng trên dòng lệnh — mọi tham số của trainer đều nhận:

    python benchmark/solov2_phuongquynh/scripts/train.py --config benchmark/solov2_phuongquynh/configs/train/solov2_r50_mm.yaml --epochs 100 --imgsz 640 --batch 16 
