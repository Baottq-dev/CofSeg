...
"""Chấm một model trên một split, qua một đường chung cho mọi model.
    ...
    python benchmark/mask2former/evaluate.py --config benchmark/mask2former/configs/eval/mask2former_r50_d2.yaml --weights <best.pt>
    python benchmark/mask2former/evaluate.py --config benchmark/mask2former/configs/eval/mask2former_r50_d2.yaml --weights <best.pt> --data data/export/field/f1 --split test
