# Nhật ký thí nghiệm — Mask2Former R50

Người ghi: AnhVu. Mỗi lần chạy thật một dòng, ghi ngay sau khi chạy xong —
...
`benchmark/mask2former/evaluate.py`, không lấy số detectron2/mmdet in ra lúc train (khác
cách tính Boundary).
